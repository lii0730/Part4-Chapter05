...
import com.example.aop_part4_chapter05.utility.AccessTokenUtil
...
class LoginActivity : AppCompatActivity(), CoroutineScope {
	...
	suspend fun getAccessToken(code: String) = launch(coroutineContext) {
		...
		withContext(Dispatchers.IO) {
			...
			//TODO: Token SharedPreferences 에 저장
			val saveTokenUtil = AccessTokenUtil(this@LoginActivity)
			saveTokenUtil.saveAccessToken(response.access_token)
		}
	}
